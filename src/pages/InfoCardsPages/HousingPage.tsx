    ...
    <ThemeProvider theme={theme}>
      ...
      <div className="page-container">
        <div className="content-wrapper">
          ...
          {isContainerVisible('InfoCard_housing_1') && (
            <div className="container">
              <h3>פתרונות דיור</h3>
              <p>
                מידע על פתרונות דיור מותאמים והתמיכה הזמינה.
              </p>
              <button 
                className="toggle-button"
                onClick={() => handleExpand('InfoCard_housing_1')}
              >
                {expandedItems['InfoCard_housing_1'] ? 'הצג פחות' : 'הצג עוד'}
              </button>
              
              <div className={`expandable-content ${expandedItems['InfoCard_housing_1'] ? 'expanded' : ''}`}>
                <div className="content-section with-image">
                  <img className="inline-image" src="/housing-solutions.jpg" alt="Housing Solutions" />
                  <div className="text-side">
                    <h3>אפשרויות דיור</h3>
                    <div className="text-content">
                      <p>
                        מידע מפורט על פתרונות הדיור הזמינים ואופן הגישה אליהם.
                      </p>
                    </div>
