    ...
    <ThemeProvider theme={theme}>
      ...
      <div className="page-container">
        <div className="content-wrapper">
          ...
          {/* Container for Welfare Services */}
          {isContainerVisible('InfoCard_welfare_1') && (
            <div className="container">
              <h3>שירותי רווחה</h3>
              <p>
                מידע על שירותי הרווחה הזמינים והתמיכה המוצעת.
              </p>
              <button 
                className="toggle-button"
                onClick={() => handleExpand('InfoCard_welfare_1')}
              >
                {expandedItems['InfoCard_welfare_1'] ? 'הצג פחות' : 'הצג עוד'}
              </button>
              
              <div className={`expandable-content ${expandedItems['InfoCard_welfare_1'] ? 'expanded' : ''}`}>
                <div className="content-section with-image">
                  <img className="inline-image" src="/welfare-services.jpg" alt="Welfare Services" />
                  <div className="text-side">
                    <h3>שירותים זמינים</h3>
                    <div className="text-content">
                      <p>
                        מידע מפורט על השירותים הזמינים ואופן הגישה אליהם.
                      </p>
                    </div>
