    ...
    <ThemeProvider theme={theme}>
      ...
      <div className="page-container">
        <div className="content-wrapper">
          ...
          {/* Container for Health Services */}
          {isContainerVisible('InfoCard_health_1') && (
            <div className="container">
              <h3>שירותי בריאות</h3>
              <p>
                מידע על שירותי בריאות זמינים והתאמות רפואיות.
              </p>
              <button 
                className="toggle-button"
                onClick={() => handleExpand('InfoCard_health_1')}
              >
                {expandedItems['InfoCard_health_1'] ? 'הצג פחות' : 'הצג עוד'}
              </button>
              
              <div className={`expandable-content ${expandedItems['InfoCard_health_1'] ? 'expanded' : ''}`}>
                <div className="content-section with-image">
                  <img className="inline-image" src="/health-services.jpg" alt="Health Services" />
                  <div className="text-side">
                    <h3>שירותי בריאות ורפואה</h3>
                    <div className="text-content">
                      <p>
                        מידע מפורט על שירותי בריאות, התאמות רפואיות, וזכויות רפואיות.
                      </p>
                    </div>
