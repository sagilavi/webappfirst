    ...
    <ThemeProvider theme={theme}>
      ...
      <div className="page-container">
        <div className="content-wrapper">
          ...
          {/* Container for Home Adjustments */}
          {isContainerVisible('InfoCard_home_adjustments_1') && (
            <div className="container">
              <h3>התאמות ושינויים בבית</h3>
              <p>
                מידע על התאמות ושינויים שניתן לבצע בבית לשיפור הנגישות והנוחות.
              </p>
              <button 
                className="toggle-button"
                onClick={() => handleExpand('InfoCard_home_adjustments_1')}
              >
                {expandedItems['InfoCard_home_adjustments_1'] ? 'הצג פחות' : 'הצג עוד'}
              </button>
                ...
                <div className="content-section with-image">
                  ...
                  <div className="text-side">
                    ...
                    <div className="text-content">
                      <p>
                        מידע מפורט על אפשרויות התאמה ושיפור הנגישות בבית, כולל מימון וסיוע.
                      </p>
                    </div>
